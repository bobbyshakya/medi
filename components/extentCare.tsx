...
const COLLECTION_ID = "SocialActivities"
  ...
  <section className="py-10 bg-white relative overflow-hidden">
    <div className="container mx-auto md:px-0 px-4 relative">
      <div className="grid lg:grid-cols-12 gap-12 items-center">
        {/* Skeleton for Content (Left on desktop, top on mobile) */}
        <div className="lg:col-span-5 space-y-5 lg:order-1 order-2 mt-8 lg:mt-0">
        ...
        {/* Skeleton for Carousel (Right on desktop, bottom on mobile) */}
    ...
    <section className="md:py-10 py-10 bg-gray-50  md:px-0 px-2 relative overflow-hidden">
      <div className="container mx-auto relative">
        <div className="grid lg:grid-cols-12 md:gap-12 items-center">
          ...
          {/* Carousel Column - Displayed last on mobile, then on the right on desktop */}
          <div className="lg:col-span-7 lg:order-1 order-2">
            <div className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
              {/* Main Carousel */}
              <div className="relative overflow-hidden shadow-sm bg-white/10 backdrop-blur-sm border border-white/20">
                <div
                  ref={carouselRef}
                  ...
                  {moments.map((moment, index) => {
                    ...
                    return (
                      <div key={moment._id} className="w-full flex-shrink-0 relative">
                        <div className="relative h-56 md:h-[520px] bg-gradient-to-br from-gray-100 to-gray-200">
                          {imageUrl ? (
                            <OptimizedImage
                              src={imageUrl}
